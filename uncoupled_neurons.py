...
xlabel("Time (ms)")
title("Raster Plot for spiking behaviour of 100 uncoupled neurons")

savefig("/Users/Parasite/Documents/D/Codes/py codes/Plots/uncoupled_neurons.png", dpi = 1200)
